...
public class SparkTest2 {
    public static void main(String[] args) {
        ...
        JavaSparkContext context = new JavaSparkContext("local", "test3", conf);
        ...
        JavaPairRDD<String, Integer> result = pairs.aggregateByKey(0, new Function2<Integer, Integer, Integer>() {
            @Override
            ...
            @Override
            public Integer call(Integer u, Integer integer) throws Exception {
                return u + integer;
            }
        });
